...
fn main() {
    ...
    let output = find_output(input, 1000);
    dbg!(output);
}
...
fn find_output(input: &str, break_point: usize) -> String {
    ...
    for connection in 0..break_point {
        let box1 = connections[connection].position1;
        let box2 = connections[connection].position2;
